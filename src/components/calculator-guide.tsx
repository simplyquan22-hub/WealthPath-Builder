...
const glassCardClasses = "rounded-lg border border-white/10 bg-card/50 backdrop-blur-sm text-card-foreground shadow-[0_0_15px_2px_rgba(0,100,255,0.35)]";
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      <Card className={glassCardClasses}>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          ...
          <ul className="space-y-3">
            ...
            <li>
              <strong className="text-foreground">Interest Rate (%):</strong> Your estimated annual return on investment. A common benchmark is the average historical return of the S&P 500, which is around <span className="text-primary">7-10%</span>.
            </li>
            <li>
              <strong className="text-foreground">Annual Fees (%):</strong> The yearly cost of managing your investments, like an ETF expense ratio. A low-cost index fund might have fees around <span className="text-primary">0.03%</span>, while actively managed funds can be <span className="text-destructive">1% or higher</span>.
            </li>
             <li>
            ...
            <li>
              <strong className="text-foreground">Adjust for Inflation:</strong> When enabled, this projects the future value of your investment in <span className="text-primary">today's dollars</span>, giving you a clearer sense of its future purchasing power.
            </li>
             <li>
      ...
      <Card className={glassCardClasses}>
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold text-lg text-green-400">Roth IRA</h4>
            <p className="text-muted-foreground">
              Contributions are made with <span className="text-foreground font-medium">after-tax</span> dollars. This means you pay taxes on the money before you invest it. The key benefit is that your qualified withdrawals in retirement are <span className="text-primary font-medium">100% tax-free</span>.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-lg text-green-400">Traditional IRA</h4>
            <p className="text-muted-foreground">
          ...
          <div>
            <h4 className="font-semibold text-lg text-green-400">Kids Roth IRA</h4>
            <p className="text-muted-foreground">
              A custodial Roth IRA for minors. Contributions are made with <span className="text-foreground font-medium">after-tax</span> dollars from the child's earned income. Like a standard Roth IRA, qualified withdrawals in retirement are <span className="text-primary font-medium">tax-free</span>, giving them a huge head start on tax-free growth.
            </p>
          </div>
           <div>
            <h4 className="font-semibold text-lg text-green-400">Kids Traditional IRA</h4>
            <p className="text-muted-foreground">
